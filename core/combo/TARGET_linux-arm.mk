...
TARGET_arm_CFLAGS :=    -O3 \
                        ...
                        -ftree-vectorize \
                        -pipe $(STRICT_ALIASING_WARNINGS) -Wno-error=strict-aliasing --enable-compile-warnings=yes
...
TARGET_GLOBAL_CFLAGS += \
			...
			-fno-short-enums \
			-pipe \
			$(arch_variant_cflags) $(STRICT_ALIASING_WARNINGS) -Wno-error=strict-aliasing --enable-compile-warnings=yes
